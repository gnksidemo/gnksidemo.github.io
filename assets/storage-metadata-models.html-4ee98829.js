import{_ as n,W as s,X as e,a1 as a}from"./framework-a045178c.js";const t={},i=a(`<h1 id="storage-metadata-models" tabindex="-1"><a class="header-anchor" href="#storage-metadata-models" aria-hidden="true">#</a> Storage Metadata Models</h1><p>The Greenfield is designed to be as compatible as possible with popular Web2 and Web3 standards. It provides developers with similar API primitives and models as the most popular Web2 cloud storage: AWS s3.</p><h2 id="abstract" tabindex="-1"><a class="header-anchor" href="#abstract" aria-hidden="true">#</a> Abstract</h2><p>Below are the basic data models for Greenfield storage:</p><ul><li>bucket</li><li>object</li><li>group</li><li>permission</li></ul><p>These metadata are stored as blockchain state into the persistent storage of the Greenfield blockchain.</p><h2 id="concepts" tabindex="-1"><a class="header-anchor" href="#concepts" aria-hidden="true">#</a> Concepts</h2><h3 id="bucket" tabindex="-1"><a class="header-anchor" href="#bucket" aria-hidden="true">#</a> Bucket</h3><p>Bucket is the unit to group storage &quot;objects&quot;. BucketName has to be globally unique. Every user account can create several buckets. The account will become the &quot;owner&quot; of the bucket.</p><p>Each bucket should be associated with its own Primary SP, and the payment accounts for Read and Store. The owner&#39;s address will be the default payment account.</p><p>The prototype definition of a bucket:</p><div class="language-protobuf line-numbers-mode" data-ext="protobuf"><pre class="language-protobuf"><code><span class="token keyword">message</span> <span class="token class-name">BucketInfo</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token builtin">string</span> id<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23),o=[i];function c(l,p){return s(),e("div",null,o)}const u=n(t,[["render",c],["__file","storage-metadata-models.html.vue"]]);export{u as default};
